...
export function BaseCardSection({
    ...
    return (
        <div className="base-card-container" {...rest}>
            <div
                className="base-card-widget-container"
                style={{ height: '26%' }}
            >
                    ...
                    <div className="type-rarity-container">
                        <FormControl style={{ marginRight: '.5rem' }}>
                            ...
                            >
                                ...
                                <MenuItem value={BaseCardType.Unit}>
                                    Unit
                                </MenuItem>
                                <MenuItem value={BaseCardType.Event}>
                                    Event
                                </MenuItem>
                                <MenuItem value={BaseCardType.ContinuousEvent}>
                                    Continuous Event
                                </MenuItem>
                                <MenuItem value={BaseCardType.Item}>
                                    Item
                                </MenuItem>
                        ...
                        <FormControl style={{ marginRight: '.5rem' }}>
                            ...
                            >
                                ...
                                <MenuItem value={Rarity.Common}>
                                    Common
                                </MenuItem>
                                <MenuItem value={Rarity.Uncommon}>
                                    Uncommon
                                </MenuItem>
