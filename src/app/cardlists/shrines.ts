...
export const shrines: Shrine[] = [
    ...
    {
        name: 'Arcane Archipelago - Lost Libraries',
        filename: 'arcanearchipelagolostlibraries',
        id: 9,
        identity: Element.Water,
        hp: 21,
        power: 0,
        speed: 0,
        text: '(C): Once per turn; (1): Choose one:\n- Pay (2) less for the next Event you play this turn if it is played as your action.\n- The next Water Unit you play this turn cannot be negated.',
        artist: 'Romar Adriano Olasiman',
        rarity: Rarity.Epic,
        type: CardType.Shrine,
    },
    {
        name: 'Crimson Canyon - The Pits',
        filename: 'crimsoncanyonthepits',
        id: 10,
        identity: Element.Fire,
        hp: 19,
        power: 0,
        speed: 0,
        text: '(C): Once per turn; (1): Place 1 damage on a (Combat) Unit you control: Until end of turn, that Unit gains +1 Pwr, Accuracy, or Swiftstrike 2.',
        artist: 'Matias Novoa',
        rarity: Rarity.Epic,
        type: CardType.Shrine,
    },
    {
        name: "Wanderer's Valley - Agora For The Lost",
        filename: 'wanderer_svalleyagoraforthelost',
        id: 11,
        identity: Element.Light,
        hp: 19,
        power: 0,
        speed: 0,
        text: '(C): Once per turn; (1): You may play target (Dead) non-Epic Item until end of turn.',
